...
public class RealEstateAgency implements ActionListener, ListSelectionListener {
    ...
    @EJB
    private static ComparePropertySessionBeanRemote compareProperty;
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        } else if (event.getSource() == gui.getAddCompareButton()) {
                   compareProperty.addPropertyID(gui.getPropertyId());
        }else if (event.getSource() == gui.getRemoveComapreButton()) {
                          compareProperty.removePropertyID(gui.getPropertyId());
        }else if (event.getSource() == gui.getGetBestPerRoom()) {
                    
                   gui.updateCompareResult(compareProperty.bestPerRoom());           
        } else {
            System.exit(0);
        }
    }
