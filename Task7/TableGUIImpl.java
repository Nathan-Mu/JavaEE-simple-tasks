...
public class TableGUIImpl extends JFrame implements MonthlyPaymentCalculatorandRealEstateAgencyGUIInterface {
    ...
    // new buttons
    private final JButton addCompareButton;
    private final JButton removeComapreButton;
    private final JButton getBestPerRoom;
    ...
    public TableGUIImpl(ActionListener actionListener, ListSelectionListener listSelectionListener) {
        ...
        calcPanel = new JPanel(new GridLayout(10, 2));
        //container.add(buttonPanel,BorderLayout.SOUTH);
        calcPanel.add(buttonPanel);
        calcPanel.add(new JLabel("<--Commands"));
        ...
        this.addCompareButton = new JButton("Add Compare");
        this.removeComapreButton = new JButton("Remove Compare");
        this.getBestPerRoom = new JButton("Best Per Room");

        this.addCompareButton.addActionListener(actionListener);
        this.removeComapreButton.addActionListener(actionListener);
        this.getBestPerRoom.addActionListener(actionListener);
        
        calcPanel.add(new JLabel("Comparing"));
        calcPanel.add(new JLabel("Properties"));
        calcPanel.add(addCompareButton);
        calcPanel.add(removeComapreButton);
        calcPanel.add(getBestPerRoom);
        CompareResultLabel = new JLabel();
        CompareResultLabel.setHorizontalAlignment(JLabel.CENTER);
        calcPanel.add(CompareResultLabel);
    ...
    public JButton getAddCompareButton() {
        return addCompareButton;
    }

    public JButton getRemoveComapreButton(){
        return removeComapreButton;
    }

    public JButton getGetBestPerRoom() {
        return getBestPerRoom;
    }
    ...
    @Override
    public void updateCompareResult(int result) {
        this.CompareResultLabel.setText(Integer.toString(result));
    }
}
